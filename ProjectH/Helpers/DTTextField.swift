...
public class DTTextField: UITextField {
    ...
    public var floatPlaceholderFont = UIFont.systemFont(ofSize: 14.0){
        didSet{ invalidateIntrinsicContentSize() }
    }
    ...
    public var borderColor:UIColor = UIColor(red: 89/255.0, green: 140/255.0, blue: 158/255.0, alpha: 0){
